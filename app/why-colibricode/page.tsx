...
const pillars: Pillar[] = [
  {
    title: "Build-from-scratch, done like adults",
    desc: "We take greenfield from idea → production with real architecture, clean interfaces, and an ops-ready baseline—not a one-off demo.",
  },
  {
    title: "Workshop over factory",
    desc: "Small, senior-heavy teams who think with you. No rotating bench of anonymous juniors pushing tickets.",
  },
  {
    title: "A stack we actually live in",
    desc: "Drupal, Symfony, Laravel, React/Next.js, Python, Go, and DevOps. We stay in the tools we can ship and support in production.",
  },
  {
    title: "Production-first decisions",
    desc: "Performance, security, observability, and operability are part of the build. “Works on demo day” doesn’t count.",
  },
];
...
const contrasts: ContrastItem[] = [
  {
    ...
    us: "Lean senior engineers who stay on the project and carry context across months.",
    notUs: "Ever-changing squads where you re-explain everything every sprint.",
  },
  {
    title: "Build-from-scratch approach",
    us: "Start with a thin vertical slice (auth → core workflow → deploy) and expand with strong foundations.",
    notUs: "A big bang build with a “we’ll harden it later” plan that never happens.",
  },
  {
    title: "Scope & planning",
    us: "Clear phases and milestones, trade-offs explained in plain language, no hidden work.",
    notUs: "Vague estimates that slide, with surprises showing up near launch.",
  },
  {
    title: "Communication",
    us: "Written updates, documented decisions, async-friendly collaboration that doesn’t depend on constant calls.",
    notUs: "Chaos in group chats, decisions lost in meetings nobody wrote down.",
  },
  {
    title: "Tech choices",
    us: "Choose proven tools where possible and explain why. Save novelty for where it actually matters.",
    notUs: "Chasing hype frameworks and leaving you with a unique snowflake nobody wants to maintain.",
  },
];
...
const steps: Step[] = [
  {
    ...
    desc: "We start with your context: goals, constraints, users, deadlines, and what’s forcing a decision right now. If there’s existing code, we review the risky parts: architecture, pipelines, deploys, and production pain.",
  },
  {
    label: "02",
    title: "Propose a concrete first phase",
    desc: "We map a small but meaningful start—often a 4–6 week phase that proves value and reduces risk. For greenfield, this is usually a thin vertical slice shipped end-to-end.",
  },
  {
    label: "03",
    title: "Iterate with production in mind",
    desc: "We ship in slices, not in one big bang. Every phase leaves your system better than before—even if we stop tomorrow—because the foundations (tests, CI, deploys, visibility) are real.",
  },
];

const techTags: string[] = [
  "Build-from-scratch delivery",
  "Drupal engineering",
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-50 text-neutral-900">
              ...
              <h1 className="text-4xl font-bold leading-[1.1] tracking-tight sm:text-5xl lg:text-6xl">
                ...
                <span className="block mt-1">
                  ...
                  <span className="ml-2 text-2xl align-middle text-neutral-500">
                    when the work has to hold up in production.
                  </span>
                </span>
              </h1>

              <p className={`max-w-2xl text-lg leading-relaxed ${brand.gray}`}>
                ColibriCode is a Denver-based engineering workshop for build-from-scratch delivery,
                modernization, and stabilization. Clients come to us when they’re tired of throwaway builds
                and want systems they can trust, operate, and grow.
              </p>

              <p className="text-sm text-neutral-500">
                Less PowerPoint, more commits. Less “resource allocation,” more senior engineers who care how
                this works a year from now—under load, during incidents, and through handoff.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative space-y-4 rounded-3xl border border-neutral-200 bg-white/80 p-7 shadow-xl backdrop-blur-sm text-sm">
                ...
                <p className={`text-sm ${brand.gray}`}>
                  We behave like an internal senior squad: helping you make trade-offs, documenting decisions,
                  pairing with your team, and leaving you with a system you can own.
                </p>
                <ul className="space-y-2 text-sm text-neutral-800">
                  <li className="flex gap-2">
                    <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-red-500" />
                    <span>We build the boring fundamentals early: CI/CD, deploys, rollback, visibility.</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-red-500" />
                    <span>We surface risk early instead of hiding behind process and status reports.</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-red-500" />
                    <span>We say “no” when something endangers maintainability, security, or operability.</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-10 text-center">
            ...
            <p className={`mx-auto mt-4 max-w-2xl text-base ${brand.gray}`}>
              We stay close to the code and optimize for long-term outcomes: systems that ship cleanly,
              run predictably, and don’t collapse when the original builders leave.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {pillars.map((p) => (
              ...
              >
                ...
                <h3 className="relative text-sm font-bold text-neutral-900">{p.title}</h3>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            {contrasts.map((item) => (
              ...
              >
                <div className="absolute right-0 top-0 h-24 w-24 bg-gradient-to-br from-red-600/10 to-transparent blur-2xl" />
                <h3 className="relative text-sm font-semibold text-neutral-900">{item.title}</h3>

                <div className="relative mt-4 grid gap-4 text-sm md:grid-cols-2">
                  <div className="rounded-2xl border border-red-100 bg-red-50/70 p-4">
                    <p className={`text-[11px] font-semibold uppercase tracking-[0.2em] ${brand.red}`}>
                      COLIBRICODE
                    </p>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-10 text-center">
            <p className={`text-sm font-bold uppercase tracking-[0.2em] ${brand.red}`}>FIT</p>
            <h2 className="mt-4 text-3xl font-bold tracking-tight lg:text-4xl">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {fitItems.map((block) => (
              ...
              >
                <div className="absolute right-0 top-0 h-24 w-24 bg-gradient-to-br from-red-600/10 to-transparent blur-2xl" />
                <h3 className="relative text-sm font-bold text-neutral-900">{block.title}</h3>
      ...
      <section className="py-20 bg-neutral-900 text-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <p className="mt-10 text-center text-xs text-neutral-400">
            Most collaborations start as a focused phase. If we both like how it feels, we extend into a longer
            roadmap or an embedded squad.
          </p>
        </div>
      </section>
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className={`mt-4 text-base ${brand.gray}`}>
                We’re based in Denver, and we work remote-first with teams across North America and Europe.
                Collaboration is built around overlap hours when needed, async updates by default, and clear ownership.
              </p>
              <ul className="mt-4 space-y-2 text-sm text-neutral-800">
                <li>Written updates you can forward to stakeholders without rewriting.</li>
                <li>Standups and reviews in overlapping hours when they’re useful—not compulsory.</li>
                <li>Decision logs and handoffs so knowledge doesn’t disappear.</li>
              </ul>
            </div>
            ...
            <div className="rounded-3xl border border-neutral-200 bg-neutral-50 p-7 text-sm shadow-sm">
              ...
              <ul className="mt-3 space-y-3 text-neutral-800">
                <li>
                  ...
                  The team you call when you need adults in the room for architecture, refactors, and sensitive launches.
                </li>
                <li>
                  <span className="font-semibold text-neutral-900">“Engineers who explain trade-offs.” </span>
                  You don’t just get a yes/no answer—you get the why and the alternatives.
                </li>
                <li>
                  <span className="font-semibold text-neutral-900">“Calm under pressure.” </span>
        ...
        <div className="mx-auto max-w-5xl px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-3xl border border-neutral-200 bg-gradient-to-br from-white via-red-50/35 to-neutral-50 p-10 shadow-xl lg:p-14">
            ...
            <div className="relative space-y-5">
              <p className={`text-xs font-bold uppercase tracking-[0.2em] ${brand.red}`}>NEXT STEP</p>
              ...
              <p className={`max-w-2xl text-sm leading-relaxed ${brand.gray}`}>
                Send a brief with your goals, stack, constraints, and what “better” looks like in six months.
                We’ll reply with a concrete recommendation for a first phase—often a 4–6 week slice that proves value and reduces risk.
              </p>
