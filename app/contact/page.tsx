        ...
        <main className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-50 text-neutral-900">
            ...
            <span className="relative flex h-2 w-2">
              ...
              CONTACT • COLIBRICODE
                  ...
                  <span className="relative z-10">Drupal, PHP, JS, Python, or Go</span>
                  <span className="absolute bottom-1 left-0 h-3 w-full bg-gradient-to-r from-red-600/20 to-red-600/40" />
                            ...
                            <p className={`max-w-2xl text-lg leading-relaxed ${brand.gray}`}>
                                Whether you need a rescue on a legacy platform, a new product build,
                                or a senior squad embedded with your team, this is the best place to
                                start. A short, honest brief is more valuable than a perfect RFP.
                            </p>
                            <ul className="space-y-2 text-sm text-neutral-700">
                                <li>• We’re based in Denver metro (Lakewood, CO), USA.</li>
                                <li>• We mostly work with teams in North America and Europe.</li>
                                <li>• English-first communication, async-friendly, engineering-led.</li>
                            </ul>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-medium text-neutral-900">
                                            200 Union Blvd, Lakewood, CO 80228, USA
                                        </p>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <path
                                            ...
                                            strokeLinejoin="round"
                                            strokeWidth={2}
                                            d="M12 22s7-5.373 7-12A7 7 0 005 10c0 6.627 7 12 7 12z"
                                        />
                                    </svg>
                                </a>
                            </div>
                ...
                <div className="mx-auto max-w-5xl px-6 lg:px-8">
                    <div className="mb-10 text-center">
                        ...
                        <h2 className="mt-4 text-2xl font-bold tracking-tight lg:text-3xl">
                            A short form is enough to get started.
                        </h2>
                        <p className={`mx-auto mt-4 max-w-2xl text-sm ${brand.gray}`}>
                            You don’t need a full specification. A few paragraphs about your
                            context, current stack, and what &ldquo;better&rdquo; looks like is
                            more than enough for an initial assessment.
                        </p>
                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    >
                                        ...
                                        <option value="new-build">New product / greenfield build</option>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <textarea
                                    ...
                                    rows={6}
                                    className="w-full rounded-xl border border-neutral-300 bg-white px-3 py-2.5 text-sm text-neutral-900 shadow-sm outline-none ring-0 transition focus:border-red-500"
                                    placeholder="A few paragraphs is perfect. Mention your current stack (Drupal, PHP, React/Next.js, Python, Go, cloud), where it hurts, and what &quot;better&quot; would look like."
                                />
                            </div>
                            ...
                            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                ...
                                <p className="text-xs text-neutral-500">
                                    Prefer email or a call? You can also reach us at{" "}
                                    <a
                                        href="mailto:hello@colibricode.com"
                            ...
                            {submitted && !error && (
                                <p className="text-xs font-medium text-green-700">
                                    Thank you for sharing your context. We&apos;ll review it and get
                                    back to you shortly.
                                </p>
                            )}
                        </form>
